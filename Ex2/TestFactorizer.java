...
class TestFactorizer {
    public static void main(String[] args) {
        ...
        System.out.println("Number of calls: " + ((VolatileCachingFactorizer) factorizer).al.get());
    }
}
...
class OneValueCache {
    ...
    public OneValueCache(long p, long[] factors) {
        this.lastNumber = p;
        this.lastFactors = factors != null ? factors.clone() : null;
    }
        
    public long[] getFactors(long p) {
        return (lastFactors == null || lastNumber != p) ? null : lastFactors.clone();
    }
}
